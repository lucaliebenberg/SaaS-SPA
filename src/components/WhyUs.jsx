...
const WhyUs = () => {
  return (
    <div className="w-full h-[100vh] bg-[#56AC8B] overflow-clip">
      <div className="p-[5rem]">
        <h1 className="text-[40px] font-bold text-white">Why Us</h1>
        <p className="max-w-[1141px] text-[23px] text-[#FDFDFD] pt-[3rem] font-light">
      ...
      <div className="flex justify-center align-middle ml-auto mr-auto pt-[2rem]">
