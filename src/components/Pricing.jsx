...
const Pricing = () => {
  return (
    <div className="w-full h-[101vh] bg-[#56AC8B]">
      <div>
        <h1 className="text-[40px] font-bold text-center pt-3 text-white">
          Simple pricing
        </h1>
      ...
      <div className="w-[70vw] flex flex-row justify-around align-middle ml-auto mr-auto pt-[3rem] pb-8">
        <img
          src={Pricing2}
